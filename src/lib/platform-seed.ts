...
export const SEED_APP_APPS = [
  ...
  },
  {
    id: "app-livada",
    sortOrder: 1,
    title: "Livada mea pe web",
    body: "Mere, prune și cireșe — din livadă, pe telefon.",
    image: "/images/livada.jpg",
    url: "https://aprozar-rom.com",
  },
];
...
export const SEED_ADS = [
  ...
  },
  {
    ...
    producerId: "nelu",
    productId: "rosii",
    title: "Roșii de inimă",
    body: "Nelu le culege când crapă ușor la umăr.",
    position: "home_bottom" as const,
    orientation: "horizontal" as const,
    durationHours: 48,
    displaySeconds: 5,
  ...
  },
  {
    ...
    productId: null as string | null,
    title: "Servicii Locale",
    body: "Meșteri de încredere, lângă tine.",
    position: "home_bottom" as const,
    orientation: "horizontal" as const,
    durationHours: 8760,
    displaySeconds: 10,
